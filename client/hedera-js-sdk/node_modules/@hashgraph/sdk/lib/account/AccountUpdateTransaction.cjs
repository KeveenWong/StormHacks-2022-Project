...
class AccountUpdateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    let aliasKey = update.alias != null && update.alias.length > 0 ? _Key.default._fromProtobufKey(proto.Key.decode(update.alias)) : undefined;
  ...
  _makeTransactionData() {
    return {
      ...
      alias: this._key != null ? proto.Key.encode(this._key._toProtobufKey()).finish() : null
    };
  }
