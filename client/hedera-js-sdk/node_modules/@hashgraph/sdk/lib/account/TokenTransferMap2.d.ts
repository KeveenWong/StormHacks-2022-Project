 ...
 */
/**
 * @augments {ObjectMap<TokenId, TokenTransferAccountMap2>}
 */
export default class TokenTransferMap2 extends ObjectMap<TokenId, TokenTransferAccountMap2> {
    /**
     * @param {proto.ITokenTransferList[]} transfers
     * @returns {TokenTransferMap2}
     */
    static _fromProtobuf(transfers: proto.ITokenTransferList[]): TokenTransferMap2;
    constructor();
    /**
     * @internal
