...
export default class AccountAllowanceApprovalTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: proto.ITransaction[], signedTransactions: proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: proto.ITransactionBody[]): AccountAllowanceApprovalTransaction;
    /**
     * @param {object} [props]
     ...
     * @returns {AccountAllowanceApprovalTransaction}
     */
    addHbarAllowance(spenderAccountId: AccountId | string, amount: number | string | Long | LongObject | BigNumber | Hbar): AccountAllowanceApprovalTransaction;
    /**
     ...
     * @returns {AccountAllowanceApprovalTransaction}
     */
    addTokenAllowance(tokenId: TokenId | string, spenderAccountId: AccountId | string, amount: Long | number): AccountAllowanceApprovalTransaction;
    /**
     * @internal
     ...
     * @returns {AccountAllowanceApprovalTransaction}
     */
    addTokenNftAllowance(nftId: NftId | string, spenderAccountId: AccountId | string): AccountAllowanceApprovalTransaction;
    /**
     * @internal
     * @param {TokenId | string} tokenId
     * @param {AccountId | string} spenderAccountId
     * @returns {AccountAllowanceApprovalTransaction}
     */
    addAllTokenNftAllowance(tokenId: TokenId | string, spenderAccountId: AccountId | string): AccountAllowanceApprovalTransaction;
}
